...
// Use code from bgfx example
// #define USE_IM_GUI_OTHER_FONT 1
...
bool    ImGui_ImplGlfwGL3_Init(GLFWwindow* window, bool install_callbacks)
{
	...
	int32_t height;
	{
		...
		for (uint32_t ii = 0; ii < sizeof(s_fontRangeMerge)/sizeof(s_fontRangeMerge[0]); ++ii)
		{
